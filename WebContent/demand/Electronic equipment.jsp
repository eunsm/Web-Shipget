...
<%
	...
	totalRecord = dao.getCount("Electronic equipment");
...
function block(value) {
	...
	<div class="products">
		<div class="container">
			<div class="col-md-4 products-left">
				<div class="categories animated wow slideInUp" data-wow-delay=".2s">
					...
					<ul class="cate">
						...
						<li><a href="Electronic equipment.eun"><font color="#F06464">Electronic equipment</font></a> <span>(<%=totalRecord %>)</span></li>
			...
			<%
				List<DemandVO> list = dao.getList(start, end, "Electronic equipment");
			%>
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
				<!-- <div class="products-right-grids-position animated wow slideInUp" data-wow-delay=".1s"> -->
				&nbsp; <font size="5pt">Electronic equipment</font>
		...
		<form name="readFrm" method="get">
			...
			<input type="hidden" name="type" value="Electronic equipment">
		</form>
