...
<%
	...
	totalRecord = dao.getCount("Book&Music");
...
function block(value) {
	...
	<div class="products">
			...
			<div class="col-md-4 products-left">
				<div class="categories animated wow slideInUp" data-wow-delay=".2s">
					...
					<ul class="cate">
						...
						<li><a href="Book&Music.eun"><font color="#F06464">Book &amp; Music</font></a> <span>(<%=totalRecord %>)</span></li>
		...
		<form name="readFrm" method="get">
			...
			<input type="hidden" name="type" value="Book&Music">
		</form>
