...
<%
	...
	totalRecord = dao.getCount("Game&Toy");
...
function block(value) {
	...
	<div class="products">
			...
			<div class="col-md-4 products-left">
				<div class="categories animated wow slideInUp" data-wow-delay=".2s">
					...
					<ul class="cate">
						...
						<li><a href="Game&Toy.eun"><font color="#F06464">Game &amp; Toy</font></a><span>(<%=totalRecord %>)</span></li>
		...
		<form name="readFrm" method="get">
			...
			<input type="hidden" name="type" value="Game&Toy">
		</form>
