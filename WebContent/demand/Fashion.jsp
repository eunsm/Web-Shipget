...
<%
	...
	totalRecord = dao.getCount("Fashion");
			...
			<div class="col-md-4 products-left">
				<div class="categories animated wow slideInUp" data-wow-delay=".2s">
					...
					<ul class="cate">
						...
						<li><a href="Fashion.eun"><font color="#F06464">Fashion</font></a><span>(<%=totalRecord %>)</span></li>
