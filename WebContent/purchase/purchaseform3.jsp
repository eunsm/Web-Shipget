...
<script type="text/javascript">
	...
	<div class="login-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1">구매 신청서</h3>  
			<form action="loginproc.eun" method="post">
				<div class="login-body" style="float: left: 10%;">
				상품 정보<br>
					<input type="text" class="user" name="title" value="<%=vo.getTitle() %>" required="">
					구매 수량 : <input type="number" name="buy" id="buy" min="1" max="<%=vo.getNowquan() %>"><br>
				...
				판매자 정보<br>
					...
					입금 은행 : <input type="text" class="user" name="name" value="<%=vo.getBank() %>" required="">
					계좌번호 : <input type="text" class="user" name="name" value="<%=vo.getAccountno() %>" required="">
				</div> 
				<div class="login-body" style="float: right;">
				구매자 정보<br>
					...
					전화번호 : <input type="text" class="user" name="gtel" value="<%=gvo.getPhone() %>" required="">
