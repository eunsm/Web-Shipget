    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/ShipGet/fileupload/fileuploader2.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  :'/ShipGet/fileupload/fileuploader.jsp',	//샘플 URL입니다.
 	        sCallback : '/ShipGet/SE2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
